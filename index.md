...
providers data, the package comes with functions
...
which enable users to fetch up-to-date providers information directly
from
[leaflet-providers.js](https://github.com/leaflet-extras/leaflet-providers)
...
Now that
[`use_providers()`](https://rstudio.github.io/leaflet.providers/reference/use_providers.md)
has been called with a custom `leaflet.providers` object obtained via
[`get_providers()`](https://rstudio.github.io/leaflet.providers/reference/get_providers.md)
(in this case, a previous version of the data),
[`leaflet`](https://rstudio.github.io/leaflet/) will use the custom
providers instead of the default provider data.

> Note that the package `V8` is required for
> [`get_providers()`](https://rstudio.github.io/leaflet.providers/reference/get_providers.md).
