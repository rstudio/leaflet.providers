...
providers_data <- list(
  ...
  MapTilesAPI.OSMEspagnol = "MapTilesAPI.OSMEspagnol",
  ...
  GeoportailFrance = "GeoportailFrance",
  GeoportailFrance.plan = "GeoportailFrance.plan",
  ...
  OpenSnowMap.pistes = "OpenSnowMap.pistes",
  AzureMaps = "AzureMaps",
  AzureMaps.MicrosoftImagery = "AzureMaps.MicrosoftImagery",
...
providers_details_data <- list(
  OpenStreetMap = list(
    ...
    variants = list(
      Mapnik = structure(list(), names = character(0)),
      DE = list(
        url = "https://tile.openstreetmap.de/{z}/{x}/{y}.png",
        options = list(maxZoom = 18L)
      ),
      CH = list(
        url = "https://tile.osm.ch/switzerland/{z}/{x}/{y}.png",
        options = list(
          maxZoom = 18L,
          bounds = structure(c(45L, 48L, 5L, 11L), dim = c(2L, 2L))
        )
      ),
      France = list(
  ...
  Stadia = list(
    ...
    variants = list(
      ...
      StamenTonerBackground = list(
        options = list(
          attribution = "&copy; <a href=\"https://www.stadiamaps.com/\" target=\"_blank\">Stadia Maps</a> &copy; <a href=\"https://www.stamen.com/\" target=\"_blank\">Stamen Design</a> &copy; <a href=\"https://openmaptiles.org/\" target=\"_blank\">OpenMapTiles</a> {attribution.OpenStreetMap}",
          variant = "stamen_toner_background"
        )
      ),
      StamenTonerLines = list(
        options = list(
          attribution = "&copy; <a href=\"https://www.stadiamaps.com/\" target=\"_blank\">Stadia Maps</a> &copy; <a href=\"https://www.stamen.com/\" target=\"_blank\">Stamen Design</a> &copy; <a href=\"https://openmaptiles.org/\" target=\"_blank\">OpenMapTiles</a> {attribution.OpenStreetMap}",
          variant = "stamen_toner_lines"
        )
      ),
      StamenTonerLabels = list(
        options = list(
          attribution = "&copy; <a href=\"https://www.stadiamaps.com/\" target=\"_blank\">Stadia Maps</a> &copy; <a href=\"https://www.stamen.com/\" target=\"_blank\">Stamen Design</a> &copy; <a href=\"https://openmaptiles.org/\" target=\"_blank\">OpenMapTiles</a> {attribution.OpenStreetMap}",
          variant = "stamen_toner_labels"
        )
      ),
      StamenTonerLite = list(
        options = list(
          attribution = "&copy; <a href=\"https://www.stadiamaps.com/\" target=\"_blank\">Stadia Maps</a> &copy; <a href=\"https://www.stamen.com/\" target=\"_blank\">Stamen Design</a> &copy; <a href=\"https://openmaptiles.org/\" target=\"_blank\">OpenMapTiles</a> {attribution.OpenStreetMap}",
  ...
  FreeMapSK = list(
    ...
    options = list(
      ...
      subdomains = "abcd",
      bounds = structure(
        c(47.204642, 49.830896, 15.996093, 22.576904),
        dim = c(2L, 2L)
      ),
  ...
  HikeBike = list(
    ...
    variants = list(
      HikeBike = structure(list(), names = character(0)),
      HillShading = list(options = list(maxZoom = 15L, variant = "hillshading"))
    )
  ),
  BasemapAT = list(
    ...
    options = list(
      ...
      format = "png",
      bounds = structure(
        c(46.35877, 49.037872, 8.782379, 17.189532),
        dim = c(2L, 2L)
      ),
    ...
    variants = list(
      ...
      overlay = "bmapoverlay",
      terrain = list(
        options = list(variant = "bmapgelaende", type = "grau", format = "jpeg")
      ),
      surface = list(
        options = list(
      ...
      highdpi = list(options = list(variant = "bmaphidpi", format = "jpeg")),
      orthofoto = list(
        options = list(
          maxZoom = 20L,
  ...
  nlmaps = list(
    ...
    options = list(
      minZoom = 6L,
      maxZoom = 19L,
      bounds = structure(c(50.5, 54, 3.25, 7.6), dim = c(2L, 2L)),
  ...
  NASAGIBS = list(
    ...
    options = list(
      ...
      bounds = structure(
        c(-85.0511287776, 85.0511287776, -179.999999975, 179.999999975),
        dim = c(2L, 2L)
      ),
      minZoom = 1L,
      maxZoom = 9L,
    ...
    variants = list(
      ...
      ViirsEarthAtNight2012 = list(
        options = list(variant = "VIIRS_CityLights_2012", maxZoom = 8L)
      ),
      ModisTerraLSTDay = list(
        options = list(
  ...
  JusticeMap = list(
    ...
    options = list(
      ...
      size = "county",
      bounds = structure(c(14L, 72L, -180L, -56L), dim = c(2L, 2L))
    ),
    variants = list(
      income = "income",
  ...
  OneMapSG = list(
    ...
    options = list(
      ...
      minZoom = 11L,
      maxZoom = 18L,
      bounds = structure(c(1.56073, 1.16, 104.11475, 103.502), dim = c(2L, 2L)),
  ...
  USGS = list(
    ...
    variants = list(
      USTopo = structure(list(), names = character(0)),
      USImagery = list(
  ...
  AzureMaps = list(
    ...
    variants = list(
      ...
      MicrosoftWeatherInfraredMain = list(
      ...
      MicrosoftWeatherRadarMain = list(
        url = "https://atlas.microsoft.com/map/tile?api-version={apiVersion}&tilesetId={variant}&x={x}&y={y}&zoom={z}&timeStamp={timeStamp}&language={language}&subscription-key={subscriptionKey}",
        options = list(
          timeStamp = "2021-05-08T09:03:00Z",
          attribution = "See https://docs.microsoft.com/en-us/rest/api/maps/render-v2/get-map-tile#uri-parameters for details.",
  ...
  SwissFederalGeoportal = list(
    ...
    options = list(
      ...
      maxZoom = 18L,
      bounds = structure(
        c(45.398181, 48.230651, 5.140242, 11.47757),
        dim = c(2L, 2L)
      )
    ),
    variants = list(
