...
providers_data <- list(OpenStreetMap = "OpenStreetMap", OpenStreetMap.Mapnik = "OpenStreetMap.Mapnik", 
    ...
    FreeMapSK = "FreeMapSK", MtbMap = "MtbMap", CartoDB = "CartoDB", 
    CartoDB.Positron = "CartoDB.Positron", CartoDB.PositronNoLabels = "CartoDB.PositronNoLabels", 
...
providers_details_data <- list(OpenStreetMap = list(url = "//{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", 
    ...
    Stamen = list(url = "//stamen-tiles-{s}.a.ssl.fastly.net/{variant}/{z}/{x}/{y}{r}.{ext}", 
        options = list(attribution = "Map tiles by <a href=\"http://stamen.com\">Stamen Design</a>, <a href=\"http://creativecommons.org/licenses/by/3.0\">CC BY 3.0</a> &mdash; Map data {attribution.OpenStreetMap}", 
            ...
            TopOSMRelief = list(url = "//stamen-tiles-{s}.a.ssl.fastly.net/{variant}/{z}/{x}/{y}.{ext}", 
    ...
    TomTom = list(url = "https://{s}.api.tomtom.com/map/1/tile/{variant}/{style}/{z}/{x}/{y}.{ext}?key={apikey}", 
        options = list(variant = "basic", maxZoom = 22L, attribution = "<a href=\"https://tomtom.com\" target=\"_blank\">&copy;  1992 - 2019 TomTom.</a> ", 
    ...
    FreeMapSK = list(url = "http://t{s}.freemap.sk/T/{z}/{x}/{y}.jpeg", 
        options = list(minZoom = 8L, maxZoom = 16L, subdomains = "1234", 
