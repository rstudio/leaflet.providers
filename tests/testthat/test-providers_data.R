...
testthat::test_that("providers_details structure", {
  ...
  testthat::expect_true(
    !is.null(providers_details_data[["OpenStreetMap"]][["url"]])
  )
  testthat::expect_true(
    !is.null(providers_details_data[["OpenStreetMap"]][["variants"]])
  )
  testthat::expect_true(
    !is.null(providers_details_data[["OpenStreetMap"]][["options"]])
  )

  testthat::expect_true(
    !is.null(providers_details_data[["OpenStreetMap"]][["variants"]]["Mapnik"])
  )
