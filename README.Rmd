...
[![Build status](https://ci.appveyor.com/api/projects/status/github/rstudio/leaflet-providers?svg=true)](https://ci.appveyor.com/project/rstudio/leaflet-providers)
