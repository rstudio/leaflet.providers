...
The goal of leaflet.providers is to provide regularly updated data on the third-party tile providers supported by `leaflet`. This package is to be used with `leaflet`. Using `use_providers()` and `get_providers`, users may fetch up-to-date providers information to be used in `leaflet`.
